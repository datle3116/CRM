            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Thêm mới nhiệm vụ</h4>
                    </div>
                </div>
                <!-- /.row -->
                <!-- .row -->
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form action='<c:url value="/task/add"></c:url>' class="form-horizontal form-material" method="post">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href='<c:url value="/job/detail?id=${jobId}"></c:url>' class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
